# Kitchen Renovations Canberra — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `kitchenrenovationscanberra.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://kitchenrenovationscanberra.netlify.app |
...
│   ├── officer.astro         # /tuggeranong/
│   ├── berwick.astro         # /dickson/
│   ├── beaconsfield.astro    # /belconnen/
│   ├── cardinia.astro        # /canberra-region/ (shire-wide overview)
...
├── whisper.js                # "Pete's Lead from Kitchen Renovations Canberra" played to contractor before patching caller through
...
| `TENANT_BRAND` | `Kitchen Renovations Canberra` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Kitchen Renovations Canberra."` |
...
3. Submit to Google Search Console (`sc-domain:kitchenrenovationscanberra.com.au`).
4. Set up Google Business Profile (needs registered business name "Kitchen Renovations Canberra" first).
